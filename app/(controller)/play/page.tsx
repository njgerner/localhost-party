        ...
        <form onSubmit={handleJoin} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              required
            />
            <p className="text-xs text-white/30 mt-2 text-right" style={{ fontFamily: 'var(--font-mono)' }}>
          ...
          <button
            ...
            style={{
              ...
              borderColor: isConnected && !isJoining ? 'var(--neon-cyan)' : 'rgba(255,255,255,0.2)'
            }}
          >
            {isJoining ? (
              <span className="flex items-center justify-center gap-2">
                <span className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: 'var(--neon-cyan)' }} />
                JOINING...
              </span>
            ) : isConnected ? (
              'JOIN GAME'
